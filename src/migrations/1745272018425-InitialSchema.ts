...
export class InitialSchema1719696000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_8e1f623798118e629b46a9e629" ON "user" ("phoneNumber") `,
    );
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `ALTER TABLE "vehicles" ADD CONSTRAINT "FK_20f139b9d79f917ef735efacb00" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `CREATE INDEX "IDX_7dfd50c93e9273155348a2b7d0" ON "vehicle_locations" ("vehicleId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_3bdf3abdcf8e4eb7a9de160c7e" ON "vehicle_locations" ("dispatchId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_8decd8f76a3c5cb1ecd3328e9a" ON "vehicle_locations" ("timestamp") `,
    );
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `CREATE INDEX "IDX_9e8965d4dbb68f697f8ddd6421" ON "transactions" ("reference") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_7197c322ccdd31b5c66819f0b6" ON "transactions" ("customerEmail") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_abf1f886dfbd2562badbd18c9d" ON "transactions" ("status") `,
    );
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `ALTER TABLE "dispatch" ADD CONSTRAINT "FK_838623fbcc1566e12ab28b803fc" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `CREATE INDEX "IDX_69429d0a6a4df0d1cf9e8c8855" ON "audit_logs" ("userId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_62a29a7ceb55ade7c30bacda5a" ON "audit_logs" ("action") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_8839d6e319694a25e731f26328" ON "audit_logs" ("resource") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_82ab4c7a4240ba7f9d384b3bad" ON "audit_logs" ("resourceId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d556f9a8ba1db373989c1eff36" ON "audit_logs" ("timestamp") `,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "dispatch" DROP CONSTRAINT "FK_838623fbcc1566e12ab28b803fc"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d556f9a8ba1db373989c1eff36"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_82ab4c7a4240ba7f9d384b3bad"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8839d6e319694a25e731f26328"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_62a29a7ceb55ade7c30bacda5a"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_69429d0a6a4df0d1cf9e8c8855"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_abf1f886dfbd2562badbd18c9d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7197c322ccdd31b5c66819f0b6"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9e8965d4dbb68f697f8ddd6421"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8decd8f76a3c5cb1ecd3328e9a"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3bdf3abdcf8e4eb7a9de160c7e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7dfd50c93e9273155348a2b7d0"`,
    );
    await queryRunner.query(
