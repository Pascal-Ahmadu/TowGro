...
export class TrackingController {
  ...
  async updateLocation(@Body(ValidationPipe) dto: UpdateLocationDto) {
    ...
    this.logger.debug(`[${txId}] API request to update location for vehicle ${dto.vehicleId}`);
  ...
  async getLocationHistory(
    ...
    const { data: locations } = await this.trackingService.getLocationHistory(vehicleId, start, end);
