...
export class AuthController {
  ...
  @ApiOperation({ 
    ...
    description: 'Register a biometric authentication method (fingerprint or faceId) for the authenticated user. The biometricId should be a secure hash or token generated by the client device.'
  })
  @ApiResponse({ 
    status: 201, 
