...
async login(@Body() loginDto: LoginDto, @Req() req) {
    ...
    async registerBiometric(
      ...
      return this.authService.registerBiometric(req.user.id, data.biometricId, data.type);
    }
    ...
    async authenticateWithBiometric(
      @Body() data: { userId: string; biometricId: string; type: 'fingerprint' | 'faceId' }
    ) {
      return this.authService.authenticateWithBiometric(data.userId, data.biometricId, data.type);
    }
